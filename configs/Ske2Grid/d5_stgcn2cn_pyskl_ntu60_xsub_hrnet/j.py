model = dict(
    type='RecognizerGCN',
    backbone=dict(
        type='STGCN2CN_UpSmp_AutoEncode_Grid_Progressive',
        in_channels=3,
        grid_shape=(5,5),
        progressive_joint_seq=[17],
        graph_cfg=dict(layout='coco', mode='spatial')),
    cls_head=dict(type='STGCN2CNHead', num_classes=60, in_channels=256))
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/ske2grid/d5_stgcn2cn_pyskl_ntu60_xsub_hrnet/j'
